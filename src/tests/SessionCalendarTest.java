...
class SessionCalendarTest {
	...
	private static Stream<Arguments> invalidSessionCalendarParameters(){
		...
		return Stream.of(Arguments.of(LocalDateTime.now().minusDays(1), LocalDateTime.now().plusDays(250)), //Started in the past
						Arguments.of(LocalDateTime.now().minusDays(20), LocalDateTime.now().plusDays(200)),
						Arguments.of(LocalDateTime.now().plusDays(20), LocalDateTime.now().plusDays(19)),
						Arguments.of(LocalDateTime.now().minusDays(2), LocalDateTime.now().minusDays(1)),
						Arguments.of(LocalDateTime.now().minusDays(1), LocalDateTime.now().minusDays(1)));//Started in the past
	}
