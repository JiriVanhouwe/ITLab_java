...
public class MakeUserController extends AnchorPane{
    ...
    void clickSave(MouseEvent event) {
		try {
    	userContoller.createUser(txfFirstName.getText(), txfLastName.getText(), txfUserName.getText(), cmbUserType.getValue(), cmbUserStatus.getValue(), txfPassword.getText());
		} catch(IllegalArgumentException e) {
			lblMessage.setText(e.getMessage());
		}
		lblMessage.setText("De gebruiker werd aangemaakt.");
		
		System.out.println("Als je hier komt, is het gelukt.");
	}
